...
class Sel_Res_Return extends Component {
  constructor(props) {
    super(props);
    this.state = {
      flights: []
...
if(this.state.flights.Availlable_Number_of_Economy_Seats ==0 && this.props.match.params.id3 == "Economy"){
  ...
  this.props.history.push('/edit_return_seats/'+this.props.match.params.user_id+'/'+this.props.match.params.id+"/"+this.props.match.params.id2);
}
  };
